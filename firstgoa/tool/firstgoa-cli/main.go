...
import (
	...
	"github.com/phxuecan/FirstGo/firstgoa/client"
	"github.com/phxuecan/FirstGo/firstgoa/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "firstgoa-cli",
		Short: `CLI client for the firstgoa service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "193.168.1.32:8081", "API hostname")
